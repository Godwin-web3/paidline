  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <video
        ...
        playsInline
        preload="metadata"
        src="/demo.mp4?v=vo-lock-pointer-2"
      >
        <a href="/demo.mp4?v=vo-lock-pointer-2">Download the demo</a>
      </video>
      <p className="mt-5 flex flex-wrap gap-x-5 gap-y-2 text-sm text-muted">
        <a href="/demo.mp4?v=vo-lock-pointer-2" download className="hover:text-fg">
          Download video
        </a>
