    ...
    <main>
      <section className="relative min-h-[88svh] overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-[88svh] max-w-6xl flex-col justify-end px-4 pb-14 pt-24 sm:px-6 sm:pb-20">
          ...
          <h1 className="mt-4 max-w-3xl font-display text-5xl leading-[0.95] tracking-tight text-hero sm:text-7xl lg:text-8xl">
            Stripe works because you trust Stripe.
            <span className="mt-3 block italic">Paidline exists when you will not.</span>
          </h1>
        ...
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-2">
            <p className="max-w-xl text-base leading-relaxed text-muted">
              ...
              someone in the middle is the source of truth — Stripe, a bot, a support ticket, a
              three-day hold.
            </p>
            <p className="max-w-xl text-base leading-relaxed text-muted">
      ...
      <section className="border-y border-line">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[1.05fr_1fr]">
          <div>
            <p className="text-xs uppercase tracking-wide text-muted">The dashboard</p>
            <h2 className="mt-3 font-display text-4xl tracking-tight sm:text-5xl">
              Pending. Then paid.
          ...
          <div className="overflow-hidden rounded-xl border border-line bg-surface">
            <div className="grid grid-cols-[1fr_auto] border-b border-line px-4 py-2.5 text-[11px] uppercase tracking-wide text-muted">
              <span>Invoice</span>
              <span>Status</span>
            </div>
            <div className="flex items-center justify-between border-b border-line px-4 py-4">
              <div>
                <p className="text-sm">
                  <span className="font-mono text-xs text-muted">#4821</span>
                  <span className="ml-2">September retainer</span>
                </p>
                <p className="mt-0.5 font-mono text-xs text-muted">250.00 USDC</p>
              </div>
              <span className="inline-flex items-center gap-1.5 rounded-full border border-paid/30 px-2.5 py-0.5 text-xs font-medium uppercase tracking-wide text-paid">
            ...
            <div className="flex items-center justify-between px-4 py-4">
              <div>
                <p className="text-sm">
                  <span className="font-mono text-xs text-muted">#4820</span>
                  <span className="ml-2">Design pass</span>
                </p>
                <p className="mt-0.5 font-mono text-xs text-muted">80.00 USDC</p>
              </div>
              <span className="inline-flex items-center gap-1.5 rounded-full border border-warn/30 px-2.5 py-0.5 text-xs font-medium uppercase tracking-wide text-warn">
                Pending
              </span>
            </div>
          </div>
      ...
      <section id="stripe" className="scroll-mt-20">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[1fr_1.1fr]">
          ...
          <div>
            ...
            <p className="mt-5 max-w-md text-base leading-relaxed text-muted">
              Stripe works because you trust Stripe. This exists when the seller and the buyer sit
              on different chains and neither wants a company in the middle to honestly report
              whether a payment happened. They want the Ethereum transaction checked. Not a row
              someone could fake. Not a server someone could hack.
            </p>
            <p className="mt-5 max-w-md text-base leading-relaxed text-muted">
